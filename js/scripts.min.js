...
$(document).mouseup(function(e){if(!e.target.closest('.wrapper')){$('#sideMenu').fadeOut().removeClass('open').css({'visibility':'hidden',});$('#openMenu').removeClass('expanded').css({'visibility':'visible',});$('body').css({'overflow-y':'auto',})
...
if($('#closeStoreBtn').length){$('#closeStoreBtn').click(function(){$('.user-store-section-wrapper').removeClass('active');$('#userStoreSection').fadeOut('fast','linear').removeClass('visible');$('#showUserStore').fadeIn('fast','linear');$('body').css({'overflow':'',});});}
...
$this.toggleClass('active');if(isExpanded){$('.preview-link-wrapper[data-id="'+typeLinkID+'"] .shevron-icon__component').css({'transform':!$this.hasClass('active')?'rotate(180deg)':'rotate(0deg)'});}else{$('.preview-link-wrapper[data-id="'+typeLinkID+'"] .shevron-icon__component').css({'transform':$this.hasClass('active')?'rotate(180deg)':'rotate(0deg)'});}});$('.up-tiktok, .up-opensea, .up-pinterest, .up-twitter, .up-twitch, .up-nft_gallery, .up-contact_details, .up-book, .up-bank_details, .up-pdf, .up-dropdown, .up-multi_button, .up-google_review, .up-podcast, .up-gofundme, .up-calendly, .up-qrcode, .up-commerce').click(function(){let typeLinkID=$(this).data('id');let isExpanded=$(this).data('expanded');$('.common-expanded-block[data-id="'+typeLinkID+'"], .up-tiktok[data-id="'+typeLinkID+'"], .up-opensea[data-id="'+typeLinkID+'"], .up-pinterest[data-id="'+typeLinkID+'"], .up-twitter[data-id="'+typeLinkID+'"], .up-twitch[data-id="'+typeLinkID+'"], .up-nft_gallery[data-id="'+typeLinkID+'"], .up-contact_details[data-id="'+typeLinkID+'"], .up-book[data-id="'+typeLinkID+'"], .up-pdf[data-id="'+typeLinkID+'"], .up-bank_details[data-id="'+typeLinkID+'"], .up-dropdown[data-id="'+typeLinkID+'"], .up-multi_button[data-id="'+typeLinkID+'"], .up-google_review[data-id="'+typeLinkID+'"], .up-podcast[data-id="'+typeLinkID+'"], .up-gofundme[data-id="'+typeLinkID+'"], .up-calendly[data-id="'+typeLinkID+'"], .up-qrcode[data-id="'+typeLinkID+'"], .up-commerce[data-id="'+typeLinkID+'"]').addClass('hidden');$('.preview-link-wrapper[data-id="'+typeLinkID+'"]').removeClass('bottom-border-radius');$('.link-underlayer[data-id='+typeLinkID+']').removeClass('hidden');if($('.preview-link-item__component[data-id='+typeLinkID+']').hasClass('active')){if(isExpanded){$($('.preview-link-item__component[data-id='+typeLinkID+']')).removeClass('active');$('.preview-link-wrapper[data-id="'+typeLinkID+'"] .shevron-icon__component').css({'transform':'rotate(180deg)'});}else{$($('.preview-link-item__component[data-id='+typeLinkID+']')).removeClass('active');$('.preview-link-wrapper[data-id="'+typeLinkID+'"] .shevron-icon__component').css({'transform':'rotate(0deg)'});}}else{$($('.preview-link-item__component[data-id='+typeLinkID+']')).addClass('active');$('.preview-link-wrapper[data-id="'+typeLinkID+'"] .shevron-icon__component').css({'transform':'rotate(180deg)'});}
if($(this).data('priority-class')==='blink'){$('.preview-link-wrapper[data-id='+typeLinkID+']').addClass('blink');}else if($(this).data('priority-class')==='buzz'){$('.preview-link-item__component[data-id='+typeLinkID+']').addClass('buzz');}else if($(this).data('priority-class')==='pop'){$('.preview-link-item__component[data-id='+typeLinkID+']').addClass('pop');}else if($(this).data('priority-class')==='wobble'){$('.preview-link-item__component[data-id='+typeLinkID+']').addClass('wobble');}});hideOtherNetworkLinksEmbed=(typeLinkID)=>{$('.common-expanded-block[data-id!="'+typeLinkID+'"][data-type!="dropdown"][data-type!="pdf"][data-type!="bank_details"], .up-tiktok[data-id!="'+typeLinkID+'"], .up-opensea[data-id!="'+typeLinkID+'"], .up-pinterest[data-id!="'+typeLinkID+'"], .up-twitter[data-id!="'+typeLinkID+'"], .up-twitch[data-id!="'+typeLinkID+'"], .up-nft_gallery[data-id!="'+typeLinkID+'"], .up-contact_details[data-id!="'+typeLinkID+'"], .up-book[data-id!="'+typeLinkID+'"], .up-pdf[data-id!="'+typeLinkID+'"], .up-bank_details[data-id!="'+typeLinkID+'"], .up-dropdown[data-id!="'+typeLinkID+'"], .up-multi_button[data-id!="'+typeLinkID+'"], .up-google_review[data-id!="'+typeLinkID+'"], .up-podcast[data-id!="'+typeLinkID+'"], .up-gofundme[data-id!="'+typeLinkID+'"], .up-calendly[data-id!="'+typeLinkID+'"], .up-qrcode[data-id!="'+typeLinkID+'"], .up-commerce[data-id!="'+typeLinkID+'"]').addClass('hidden');if($('.preview-link-wrapper[data-id!="'+typeLinkID+'"]').hasClass('bottom-border-radius')){$('.preview-link-wrapper[data-id!="'+typeLinkID+'"]').removeClass('bottom-border-radius');}};$('.preview-link-item__component[data-link-type="video"]').click(function(){let videoLinkID=$(this).data('id');let linkData=$('.video-link-url[data-id="'+videoLinkID+'"]');let videoLinkType=linkData.data('link-type');let videoService=linkData.data('videoservice');let videoUrl=linkData.data('videolink-url');let isEmbed=linkData.data('embed').toLowerCase();if(videoLinkType=='video'&&isEmbed=='true'){toggleElement(videoLinkID);$('.up-video[data-id='+videoLinkID+']').toggleClass('hidden');}
...
$(document).mouseup(function(e){let containers=[$('.lang-wrapper-footer'),$('.lang-wrapper-header')];let selector=$('.current-lang').children();if(!selector.is(e.target)){for(let container of containers){if(!container.is(e.target)){container.addClass('hidden');}}}});$('.lang-switcher-btn-close-popup').click(function(){$('.lang-wrapper').addClass('hidden');$('.fixed-scroll-footer').css({'z-index':10});$('body').css({'overflow':'visible'});});function langSwitcherHandler(position){let langList=$(`.lang-wrapper-${position}`);let screenWidth=window.innerWidth;if(langList.hasClass('hidden')){langList.removeClass('hidden');if(screenWidth<=500){$('.fixed-scroll-footer').css({'z-index':7});$('body').css({'overflow':'hidden'});}}else{langList.addClass('hidden');if(screenWidth<=500){$('.fixed-scroll-footer').css({'z-index':10});}}};$('.current-lang[data-position="footer"]').click(function(){langSwitcherHandler('footer');});$('.current-lang[data-position="header"]').click(function(){langSwitcherHandler('header');});const additionalMenuWindow=$('.services-help-window');const additionalDiscoverWindow=$('.services-discover-window')
const services=$('.services');const discover=$('.discover');$(document).mouseup(function(e){if(!services.is(e.target)&&!additionalMenuWindow.hasClass('hidden')){additionalMenuWindow.addClass('hidden');additionalMenuWindow.hide(100);services.toggleClass('active');}});services.click(()=>{if(additionalMenuWindow.hasClass('hidden')){additionalMenuWindow.show(100);additionalMenuWindow.toggleClass('hidden');services.toggleClass('active');}else if(!additionalMenuWindow.hasClass('hidden')){additionalMenuWindow.hide(100);additionalMenuWindow.toggleClass('hidden');services.toggleClass('active');}})
...
$('[data-action="copy-bank-field"]').click(function(e){e.stopPropagation()
...
$("#searchInputMarketplace").on("input",function(){filterItemsMarketplace($(this).val());});$(".example-bank-details").click(function(){$("#searchInputMarketplace").val('Bank Details');filterItemsMarketplace('Bank Details');});$(".example-custom-domain").click(function(){$("#searchInputMarketplace").val('Custom Domain');filterItemsMarketplace('Custom Domain');});$(".example-tiktok").click(function(){$("#searchInputMarketplace").val('TikTok');filterItemsMarketplace('TikTok');});const QUESTION=$('.question');QUESTION.click(function(e){e.preventDefault();let item_id=$(this).data('id');let answer=$('.answer[data-id='+item_id+']');if(answer.is(':visible')){$('.question-expand-button-icon[data-id="'+item_id+'"]').toggleClass('minus');$('.question-expand-button-icon[data-id="'+item_id+'"]').toggleClass('plus');answer.slideUp(600);}else{$('.question-expand-button-icon[data-id="'+item_id+'"]').toggleClass('minus');$('.question-expand-button-icon[data-id="'+item_id+'"]').toggleClass('plus');answer.slideDown(600);}});$('#searchInputWeb3Coins').on('keyup',function(){var value=$(this).val().toLowerCase();$('.crypto-items-wrapper .crypto-item').each(function(){if($(this).attr('data-name').toLowerCase().indexOf(value)>-1){$(this).show();}else{$(this).hide();}});});$('.show-all-wallets-btn').click(function(){let $this=$(this);let $content=$this.prev('.crypto-items-wrapper');$content.toggleClass('crypto-items-expanded');if($content.hasClass('crypto-items-expanded')){$(this).find('.btn-text').text('Show less wallets');}else{$(this).find('.btn-text').text('Show all wallets');$('html, body').animate({scrollTop:$('#searchInputWeb3Coins').offset().top},2000);}});$('.features-selector').click(function(e){if(!$('.features-list').hasClass('active')){$('.features-arrow-icon-right').css("transform","rotate(90deg)");$('.features-list').addClass('active');$('.features-list').slideDown(800);}else if($('.features-list').hasClass('active')){$('.features-arrow-icon-right').css("transform","rotate(0deg)");$('.features-list').removeClass('active');$('.features-list').slideUp(800);}});$('.discover-selector').click(function(e){if(!$('.discover-list').hasClass('active')){$('.discover-arrow-icon-right').css("transform","rotate(90deg)");$('.discover-list').addClass('active');$('.discover-list').slideDown(800);}else if($('.discover-list').hasClass('active')){$('.discover-arrow-icon-right').css("transform","rotate(0deg)");$('.discover-list').removeClass('active');$('.discover-list').slideUp(800);}});$('.company-selector').click(function(e){if(!$('.company-list').hasClass('active')){$('.company-arrow-icon-right').css("transform","rotate(90deg)");$('.company-list').addClass('active');$('.company-list').slideDown(800);}else if($('.company-list').hasClass('active')){$('.company-arrow-icon-right').css("transform","rotate(0deg)");$('.company-list').removeClass('active');$('.company-list').slideUp(800);}});});